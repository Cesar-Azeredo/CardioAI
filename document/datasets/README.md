...
| Hipertensão (pressão alta) (texto 2) | textual | Ministério da Saúde — Saúde de A a Z | https://www.gov.br/saude/pt-br/assuntos/saude-de-a-a-z/h/hipertensao | — | CC BY-ND 3.0 (SemDerivações) | 2026-08-27 | 1 (858 palavras) | Ministério da Saúde. *Hipertensão (pressão alta)*. Saúde de A a Z. A página-fonte não expõe data de publicação nem de atualização (verificado: sem `<time>`, sem meta `citation_*`, sem `dateModified`/`datePublished` em JSON-LD) — a data de acesso acima (2026-08-27) é a referência temporal disponível. |
...
## Cópias hospedadas por este projeto (Google Drive)

Além da fonte original (coluna URL acima), os artefatos já tratados desta
entrega estão publicados para acesso do corretor:

- **Pasta-mãe (tudo)**: https://drive.google.com/drive/folders/1kKpAlFfaA06UMaPxirurEwRaDQi6ySbg?usp=drive_link
- **Dataset numérico (CSV + XLSX)**: https://drive.google.com/drive/folders/1eTMQ1dnlVJRoTAAd39kqipLyDX-iuLCB?usp=drive_link
- **Textos (.txt)**: https://drive.google.com/drive/folders/1IKF4nawS7BT8J5obI0AqoAviMeqFcsh1?usp=drive_link — também versionados diretamente em `assets/textos/`
- **Imagens de ECG (120)**: https://drive.google.com/drive/folders/12YhReksoB8K-aWQsubtUIaEx4zK9EuF3?usp=drive_link
